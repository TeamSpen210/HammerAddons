...
Scheme
{
	...
	Colors
	{
		...
		// base colors
		"BaseText"			"220 220 220 255"	// used in text windows, lists
		...
		"ControlText"		"220 220 220 255"	// used in all text controls
		"BrightControlText"	"255 188 115 255"	// use for selected controls
		"DisabledText1"		"110 110 110 255"	// disabled text
		"DisabledText2"		"40 46 34 255"		// overlay color for disabled text (to give that inset look)
		"DimListText"		"160 160 160 255"	// offline friends, unsubscribed games, etc.

		// background colors
		"ControlBG"			"45 45 48 255"		// background color of controls
		"ControlDarkBG"		"45 45 48 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"37 37 37 255"		// background color of text edit panes (chat, text entries, etc.)
		"SelectionBG"		"166 114 59 255"	// background color of any selected text or menu item
		"SelectionBG2"		"108 60 7 255"		// selection background in window w/o focus
		...
		// border colors
		"BorderBright"		"65 65 68 255"	// the lit side of a control
		"BorderDark"		"55 55 58 255"		// the dark/unlit side of a control
...
//		Button.DepressedBgColor			"ControlDarkBG"	
		...
		ScrollBarButton.BgColor				"ListBG"
...
//		Tooltip.BgColor				"255 155 0 255"
		...
		TreeNodeText.TextColor		"ControlText"
